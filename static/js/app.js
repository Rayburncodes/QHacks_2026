...
function displaySummary(summary, stats) {
    const summaryHTML = `
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="bg-gray-50 p-4 rounded-xl text-center hover:bg-gray-100 transition">
                <div class="text-3xl font-bold text-primary">${stats.win_rate}%</div>
                <div class="text-gray-500 text-sm mt-1">Win Rate</div>
            </div>
            <div class="bg-gray-50 p-4 rounded-xl text-center hover:bg-gray-100 transition">
                <div class="text-3xl font-bold text-primary">${summary.bias_count}</div>
...
function displayCharts(results) {
    ...
    container.innerHTML = `
        ...
        <div class="mb-8 p-4 bg-gray-50 rounded-xl" id="biasChart"></div>
        <div class="mb-8 p-4 bg-gray-50 rounded-xl" id="winLossChart"></div>
    `;
}
